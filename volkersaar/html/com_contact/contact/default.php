...
$doc->addScript($this->baseurl.'/media/system/js/validate.js');
...
<?php endif; ?>
	...
	<p></p>
		<?php if ($this->params->get('presentation_style')=='plain'):?>
			<?php  echo '<h2 class="orange line"><span>'. JText::_('COM_CONTACT_EMAIL_FORM').'</span></h2>';  ?>
		<?php endif; ?>
	<?php if ($this->contact->misc && $this->params->get('show_misc')) : ?>
		<?php if ($this->params->get('presentation_style')!='plain'){?>
			<?php echo JHtml::_($this->params->get('presentation_style').'.panel', JText::_('COM_CONTACT_OTHER_INFORMATION'), 'display-misc');} ?>
		        ...
		        <?php
		        $modules = JModuleHelper::getModules('contactform'); 
