...
<article class="article news">
	<div class="article-body grid-item six-tenths">
		...
		<header>
			...
			<p><span class="date"><?php echo $newsDate->format('d.m.Y'); ?></span> | <span class="author"><a href="https://plus.google.com/104297445898014737508" title="<?php echo $cck->renderField('art_created_by'); ?>"><?php echo $cck->renderField('art_created_by'); ?></a></span><p>
...
<article class="article news">
	<div class="article-body grid-item six-tenths">
		...
		<header>
			<h1 class="blue"><?php echo $cck->getValue('art_title'); ?></h1>
			<p><span class="date"><?php echo '<span>' . $newsDate->format('d.m.Y'); ?></span> | <span class="author"><a href="https://plus.google.com/104297445898014737508" title="<?php echo $cck->renderField('art_created_by'); ?>"><?php echo $cck->renderField('art_created_by'); ?></a></span><p>
			<div class="socialicons">
				<span class='st_facebook_custom socicon' displayText='Facebook'></span>
				<span class='st_google_bmarks_custom socicon' ></span>
			</div>
