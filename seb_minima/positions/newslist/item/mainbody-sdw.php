...
/*if ($cck->getValue('art_image_fulltext')) {
	$doc->addCustomTag( "<meta property='og:image' content='" . JURI::base() . $cck->getValue('art_image_intro') . "'>" );
} else {
	$doc->addCustomTag( "<meta property='og:image' content='" . JURI::base() . "images/news/spruch_der_woche_teaser.jpg" . "'>" );
}*/
...
<article class="article news intro clearfix gbr">
